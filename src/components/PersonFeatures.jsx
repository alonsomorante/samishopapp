...
function PersonFeatures ({ person, changePerson }) {
  return (
    <div className='person-features__content'>
      <Header>
        {person.name}
        <svg onClick={changePerson} width='17px' height='17px' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      ...
      <PersonInfo feature={person.eye_color}>
        Eye Color
      </PersonInfo>
      <PersonInfo feature={person.hair_color}>
        Hair Color
      </PersonInfo>
      <PersonInfo feature={person.hair_color}>
        Skin Color
      </PersonInfo>
      <PersonInfo feature={person.birth_year}>
        Birth Year
      </PersonInfo>

      <PersonVehicle person={person} />
    </div>
  )
}
